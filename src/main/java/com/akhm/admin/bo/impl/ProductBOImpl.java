...
import com.akhm.admin.exceptions.AdminDataCustomException;
@Service
public class ProductBOImpl implements ProductBO{
	...
	try {
		...
		throw new com.akhm.admin.exceptions.AdminDataCustomException(e.getMessage());
	}
	...
	@Override
	public void updateProductTl(ProductTl productTl) {
		try {
			if(productTl!=null)
			{
