...
public class ProductController {
	...
	public ResponseEntity<Integer> saveProduct(@RequestBody ProductTl productTl) {
		try {
	...
	@GetMapping("/products")
	public ResponseEntity<List<ProductTl>> loadProducts() {
	try {
	...
	public ResponseEntity<Void> modifyProduct(@RequestBody ProductTl productTl)
	{
		try {
			productBO.updateProductTl(productTl);
